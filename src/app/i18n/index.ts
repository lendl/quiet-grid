...
const EN_STRINGS = {
  ...
  settings: {
    title: 'Settings',
    subtitle: 'Choose your theme, language, and timer display.',
    ...
    tutorialsLabel: 'Show how-to-play on first launch',
    tutorialsDetail: 'Opens the how-to-play page automatically the first time you choose a puzzle type.',
  ...
  howToPlay: {
    ...
    wrongMoveTitle: 'Mistakes',
    rulesTitle: 'Rules',
    techniquesTitle: 'Techniques',
    scoringTitle: 'Scoring',
    tipsTitle: 'Tips',
    inGameIconsTitle: 'Game icons',
    quickPlay: 'Quick Play',
    chooseDifficulty: 'Choose Difficulty',
    inGameIcons: [
      { icon: 'bulb-outline', label: 'Hint', description: 'Shows the next valid move on the board.' },
      { icon: 'flag-outline', label: 'Forfeit', description: 'Ends the current puzzle without a solution.' },
    ],
  },
  tutorialHost: {
...
const NL_STRINGS: AppStrings = {
  ...
  settings: {
    title: 'Instellingen',
    subtitle: 'Kies je thema, taal en timerweergave.',
    appearance: 'Weergave',
    theme: 'Thema',
    language: 'Taal',
    tutorials: 'Speluitleg',
    ...
    tutorialsLabel: 'Speluitleg tonen bij eerste lancering',
    tutorialsDetail: 'Opent de speluitlegpagina automatisch de eerste keer dat je een puzzeltype kiest.',
  ...
  howToPlay: {
    goalTitle: 'Doel',
    controlsTitle: 'Bediening',
    wrongMoveTitle: 'Fouten',
    rulesTitle: 'Regels',
    techniquesTitle: 'Technieken',
    scoringTitle: 'Score',
    tipsTitle: 'Tips',
    inGameIconsTitle: 'Speliconen',
    quickPlay: 'Snel spelen',
    chooseDifficulty: 'Kies moeilijkheid',
    inGameIcons: [
      { icon: 'bulb-outline', label: 'Hint', description: 'Toont de volgende geldige zet op het bord.' },
      { icon: 'flag-outline', label: 'Opgeven', description: 'Beëindigt de huidige puzzel zonder oplossing.' },
    ],
  },
  tutorialHost: {
...
const DE_STRINGS: AppStrings = {
  ...
  settings: {
    title: 'Einstellungen',
    subtitle: 'Wähle Design, Sprache und Timer-Anzeige.',
    appearance: 'Darstellung',
    theme: 'Thema',
    language: 'Sprache',
    tutorials: 'Spielanleitung',
    ...
    tutorialsLabel: 'Spielanleitung beim ersten Start anzeigen',
    tutorialsDetail: 'Öffnet die Spielanleitungsseite automatisch beim ersten Mal, wenn du einen Rätseltyp wählst.',
  ...
  howToPlay: {
    ...
    wrongMoveTitle: 'Fehler',
    rulesTitle: 'Regeln',
    techniquesTitle: 'Techniken',
    scoringTitle: 'Wertung',
    tipsTitle: 'Tipps',
    inGameIconsTitle: 'Spielsymbole',
    quickPlay: 'Schnell spielen',
    chooseDifficulty: 'Schwierigkeitsgrad wählen',
    inGameIcons: [
      { icon: 'bulb-outline', label: 'Hinweis', description: 'Zeigt den nächsten gültigen Zug auf dem Brett.' },
      { icon: 'flag-outline', label: 'Aufgeben', description: 'Beendet das aktuelle Rätsel ohne Lösung.' },
    ],
  },
  tutorialHost: {
...
const FR_STRINGS: AppStrings = {
  ...
  settings: {
    title: 'Paramètres',
    subtitle: 'Choisissez votre thème, langue et affichage de la minuterie.',
    appearance: 'Apparence',
    theme: 'Thème',
    language: 'Langue',
    tutorials: 'Comment jouer',
    ...
    tutorialsLabel: 'Afficher le guide au premier lancement',
    tutorialsDetail: 'Ouvre automatiquement la page comment jouer la première fois que vous choisissez un type de puzzle.',
  ...
  howToPlay: {
    ...
    wrongMoveTitle: 'Erreurs',
    rulesTitle: 'Règles',
    techniquesTitle: 'Techniques',
    scoringTitle: 'Score',
    tipsTitle: 'Conseils',
    inGameIconsTitle: 'Icônes du jeu',
    quickPlay: 'Jeu rapide',
    chooseDifficulty: 'Choisir la difficulté',
    inGameIcons: [
      { icon: 'bulb-outline', label: 'Indice', description: 'Affiche le prochain mouvement valide sur le plateau.' },
      { icon: 'flag-outline', label: 'Abandonner', description: 'Termine le puzzle en cours sans solution.' },
    ],
  },
  tutorialHost: {
...
const ES_STRINGS: AppStrings = {
  ...
  settings: {
    title: 'Ajustes',
    subtitle: 'Elige tu tema, idioma y visualización del temporizador.',
    appearance: 'Apariencia',
    theme: 'Tema',
    language: 'Idioma',
    tutorials: 'Cómo jugar',
    ...
    tutorialsLabel: 'Mostrar cómo jugar al primer lanzamiento',
    tutorialsDetail: 'Abre automáticamente la página cómo jugar la primera vez que eliges un tipo de puzzle.',
  ...
  howToPlay: {
    ...
    wrongMoveTitle: 'Errores',
    rulesTitle: 'Reglas',
    techniquesTitle: 'Técnicas',
    scoringTitle: 'Puntuación',
    tipsTitle: 'Consejos',
    inGameIconsTitle: 'Iconos del juego',
    quickPlay: 'Juego rápido',
    chooseDifficulty: 'Elegir dificultad',
    inGameIcons: [
      { icon: 'bulb-outline', label: 'Pista', description: 'Muestra el siguiente movimiento válido en el tablero.' },
      { icon: 'flag-outline', label: 'Abandonar', description: 'Termina el puzzle actual sin solución.' },
    ],
  },
  tutorialHost: {
