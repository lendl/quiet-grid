...
private val CLUE_CELL_SIZE = 28.dp
private val BOARD_CELL_SIZE = 32.dp
...
fun BattleshipBoard(
    ...
    Column {
        Row {
            Box(Modifier.size(CLUE_CELL_SIZE))
            colClues.forEach { clue ->
                Box(Modifier.size(CLUE_CELL_SIZE), contentAlignment = Alignment.Center) {
...
@Composable
private fun BattleshipCellView(cell: BattleshipCell, isGiven: Boolean, onPress: () -> Unit) {
