// app/src/main/java/com/quietgrid/app/games/starbattle/StarBattlePlayScreen.kt
...
@Composable
fun StarBattlePlayScreen(
    difficulty: Difficulty,
    resume: Boolean,
    onBack: () -> Unit,
    onFinished: (StarBattleResult) -> Unit,
) {
    val viewModel = hiltViewModel<StarBattlePlayViewModel, StarBattlePlayViewModel.Factory>(
...
@Composable
private fun StarBattleHeartIcon(filled: Boolean, shakeTrigger: Int, modifier: Modifier = Modifier) {
