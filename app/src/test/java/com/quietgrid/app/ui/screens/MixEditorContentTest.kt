...
class MixEditorContentTest {
    ...
    fun `editing the name then losing focus saves the new name`() {
        ...
        composeRule.setContent {
            MixEditorContent(mixId = existingMix.id, onDone = {}, repositories = repositories)
        }
        ...
        composeRule.onNodeWithText(composeRule.activity.getString(R.string.mix_delete_button)).requestFocus()
        composeRule.waitForIdle()
